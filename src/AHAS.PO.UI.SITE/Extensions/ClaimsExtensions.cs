...
namespace AHAS.PO.UI.SITE.Extensions
{
    public static class ClaimsExtensions
    {
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "AHAS.PO.INFRA.CROSS.IDENTITY.Model.RegisterViewModel.NameIdentifier")?.Value;
        }
